...
from xrd_ae.tensor_transforms import (
    Pad,
)
...
path_chkpt = f"chkpt.train_smd.{os.getenv('CUDA_VISIBLE_DEVICES')}"
...
while True:
    ...
    for batch_tuple in dataloader:
        rank, id, batch, photon_energy = batch_tuple
